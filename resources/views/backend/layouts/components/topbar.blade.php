                    ...
                    <div class="container-fluid">
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-app-name">
                                ...
                                <div class="nk-header-app-info"><span class="sub-text">DashLite</span><span
                            ...
                            <div class="nk-header-tools">
                                <ul class="nk-quick-nav">
                                    <li class="dropdown hide-mb-sm"><a data-bs-toggle="modal" href="#region"
                                            class="nk-quick-nav-icon"><em class="icon ni ni-globe"></em></a></li>
